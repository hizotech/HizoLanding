  ...
  <LayoutTcContent>
    ...
    <a href="#hizo">
      <div class="section" id="hizo">
        <h2 class="flex items-center">Introduction</h2>
        <p>
          HIZO ("we," "our," or "us") is committed to protecting your privacy.
          This Privacy Policy explains how your personal information is
          collected, used, and disclosed by Hizo. This Privacy Policy applies to
          our app, and its associated subdomains (collectively, our "Service")
          alongside our application, Hizo. By accessing or using our Service,
    ...
    <a href="#license">
      <div class="section" id="license">
        <h2 class="flex items-center">License</h2>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            to Hizo Technology Limited, (13, PIVOT PLAZA, RAIN OIL BESIDE
            CARTAGE CINEMA, OKPANAM ROAD, ASABA, DELTA STATE, NIGERIA), which is
          ...
          <li>
            ...
            the Hizo Service to manage the relationships with your consumers or
            service users
          </li>
          <li>
            <span class="heading">Device:</span>
            any internet-connected device such as a phone, tablet, computer, or
            any other device that can be used to visit Hizo and use the
            services.
          </li>
          <li>
    ...
    <a href="#information">
      <div class="section" id="information">
        <h2 class="flex items-center">What Information Do We Collect?</h2>
        <p>
    ...
    <a href="#facial-data">
      <div class="section" id="facial-data">
        <h2 class="flex items-center">Facial Data & Liveness Detection</h2>
        <p>
    ...
    <a href="#user-data">
      <div class="section" id="user-data">
        ...
        <p>
          ...
          to our customers. End users may voluntarily provide us with
    ...
    <a href="#third-party">
      <div class="section" id="third-party">
        ...
        <p>
          ...
          in becoming a Hizo customer, we receive information from a third party
          that provides automated fraud detection services to Hizo. We also
    ...
    <a href="#share">
      <div class="section" id="share">
        ...
        <p>
          ...
          our servers and the app, database storage and management, email
        ...
        <p>
          ...
          technographic such as connection speed, whether you have visited the
    ...
    <a
        ...
        >
    <div class="section" id="secure-information">
      <h2 class="flex items-center">
    ...
    <!-- Changes To Our Privacy Policy -->
     <a href="#change-privacy">
    <div class="section" id="change-privacy">
