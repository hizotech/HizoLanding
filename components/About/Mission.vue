<template>
  <div class="w-full">
    <div class="mx-auto flex flex-col md:flex-row max-w-[75rem] gap-10">
      <div class="md:w-[340px] flex-shrink-0">
        <img src="/img/mission.png" class="w-full h-auto md:h-full" alt="" />
      </div>
      <div
        class="rounded-3xl bg-white px-5 py-14 md:p-14 lg:p-24 relative overflow-hidden w-full flex justify-center items-center"
      >
        <img
          src="/img/mission_pattern_yellow.svg"
          class="absolute h-full w-auto left-[-2rem] bottom-[-7rem] md:left-0 top-0 z-0"
          alt=""
        />
