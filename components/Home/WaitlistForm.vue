<template>
  ...
  <section class="px-5 py-32" id="waitlistForm">
    ...
    >
      ...
      <div class="w-full md:w-5/12 relative z-3">
        <h1 class="font-display text-4xl font-bold text-white md:text-5xl">
          Join Nigerians all over Africa to experience <br />
          freedom
        </h1>
        <form
        ...
        >
          <input
            ...
            class="w-full min-w-[2rem] rounded-xl border-2 border-transparent bg-white bg-opacity-10 px-1 py-4 text-white placeholder-blue-200 outline-none transition-all duration-200 hover:bg-transparent hover:border-white focus:bg-transparent focus:border-white md:px-6 md:py-5"
          />
          <button
            type="submit"
