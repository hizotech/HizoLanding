<template>
  <LayoutTcContent>
    ...
    <div class="section">
      <h2>General Terms</h2>
      <p>
        By accessing and placing an order with Hizo, you confirm that you are in
        ...
        any email or other type of communication between you and Hizo.
      </p>
      <p>
        Under no circumstances shall Hizo team be liable for any direct,
        ...
        inability to use, the materials on this site, even if Hizo team or an
      ...
      <p>
        Hizo will not be responsible for any outcome that may occur during the
    ...
    <div class="section">
      <h2>License</h2>
      <p>
        Hizo grants you a revocable, non-exclusive, non-transferable, limited
        license to download, install and use the app strictly in accordance with
        the terms of this Agreement.
      </p>
      <p>
        These Terms & Conditions are a contract between you and Hizo (referred
        to in these Terms & Conditions as "Hizo", "us", "we" or "our"), the
        provider of the Hizo website and the services accessible from the Hizo
      ...
      <p>
        ...
        agree to these Terms & Conditions, please do not use the Hizo Service.
    ...
    <div class="section">
      ...
      <ul>
        ...
        <li>
          ...
          of copyright or trademark) of Hizo or its affiliates, partners,
    ...
    <div class="section">
      ...
      <p>
        Thanks for shopping at Hizo. We appreciate the fact that you like to buy
      ...
      <p>
        ...
        apply to transactions at Hizo. We’ll be as brief as our attorneys will
        allow. The main thing to remember is that by placing an order or making
        a purchase at Hizo, you agree to the terms along with Hizo’s Privacy
        Policy. If, for any reason, You are not completely satisfied with any
        good or service that we provide, don't hesitate to contact us and we
    ...
    <div class="section">
      ...
      <p>
        ...
        (collectively, "Suggestions") provided by you to Hizo with respect to
        the app shall remain the sole and exclusive property of Hizo.
      </p>
      <p>
        Hizo shall be free to use, copy, modify, publish, or redistribute the
        Suggestions for any purpose and in any way without any credit or any
        compensation to you.
      </p>
    </div>
    <!-- Your Suggestions end-->
    ...
    <div class="section">
      ...
      <p>
        You acknowledge and agree that Hizo may stop (permanently or
        temporarily) providing the Service (or any features within the Service)
        to you or to users generally at Hizo’s sole discretion, without prior
        notice to you. You may stop using the Service at any time. You do not
        need to specifically inform Hizo when you stop using the Service. You
        acknowledge and agree that if Hizo disables access to your account, you
    ...
    <div class="section">
      <h2>Modification To Our App</h2>
      <p>
        Hizo reserves the right to modify, suspend or discontinue, temporarily
        or permanently, the app or any service to which it connects, with or
        without notice and without liability to you.
      </p>
    </div>
    <!-- Modification To Our App end-->

    <!-- Updates to Our app -->
    <div class="section">
      <h2>Updates to Our app</h2>
      <p>
        Hizo may from time to time provide enhancements or improvements to the
      ...
      <p>
        ...
        the app. You agree that Hizo has no obligation to (i) provide any
    ...
    <div>
      ...
      <p>
        This Agreement shall remain in effect until terminated by you or Hizo.
        Hizo may, in its sole discretion, at any time and for any or no reason,
      ...
      <p>
        ...
        Hizo, in the event that you fail to comply with any provision of this
      ...
      <p>
        Termination of this Agreement will not limit any of Hizo's rights or
    ...
    <!-- Copyright Infringement Notice end-->
    ...
    <div class="section">
      ...
      <p>
        ...
        permitted under applicable law, Hizo, on its own behalf and on behalf of
        ...
        limitation to the foregoing, Hizo provides no warranty or undertaking,
      ...
      <p>
        Without limiting the foregoing, neither Hizo nor any Hizo's provider
        ...
        from or on behalf of Hizo are free of viruses, scripts, trojan horses,
    ...
    <div class="section">
      ...
      <p>
        Not withstanding any damages that you might incur, the entire liability
        of Hizo and any of its suppliers under any provision of this Agreement
        and your exclusive remedy for all of the foregoing shall be limited to
        the amount actually paid by you for the app. To the maximum extent
        permitted by applicable law, in no event shall Hizo or its suppliers be
        ...
        related to the use of or inability to use the app, third-party software
        and/or third-party hardware used with the app, or otherwise in
        connection with any provision of this Agreement), even if Hizo or any
    ...
    <div class="section">
      ...
      <p>
        ...
        other legal notices published by Hizo on the Services, shall constitute
        the entire agreement between you and Hizo concerning the Services. If
        ...
        any other term, and Hizo’s failure to assert any right or provision
        under this Agreement shall not constitute a waiver of such right or
        provision. YOU AND Hizo AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR
    ...
    <div class="section">
      ...
      <p>
        ...
        waiver of any subsequent breach. No failure to exercise, and no delay in
    ...
    <div class="section">
      ...
      <p>
        Hizo reserves the right, at its sole discretion, to modify or replace
        ...
        agree to the new terms, you are no longer authorized to use Hizo.
      </p>
    </div>
    <!-- Amendments to this Agreement end-->

    <!-- Entire Agreement -->
    <div class="section">
      <h2>Entire Agreement</h2>
      <p>
        The Agreement constitutes the entire agreement between you and Hizo
        regarding your use of the app and supersedes all prior and
        contemporaneous written or oral agreements between you and Hizo
      </p>
      <p>
        You may be subject to additional terms and conditions that apply when
        you use or purchase other Hizo's services, which Hizo will provide to
    ...
    <div class="section">
      ...
      <p>
        ...
        owned by Hizo, its licensors or other providers of such material and are
        protected by Nigeria and international copyright, trademark, patent,
        ...
        written permission of Hizo, unless and except as is expressly provided
    ...
    <div class="sectioon">
      ...
      <p>
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR Hizo’s INTELLECTUAL PROPERTY RIGHTS.
        The term “dispute” means any dispute, action, or other controversy
        between you and Hizo concerning the Services or this agreement, whether
    ...
    <!-- Agreement to Arbitrate end-->

    <!-- Notice of Dispute -->
    <div class="section">
      <h2>Notice of Dispute</h2>
      <p>
        In the event of a dispute, you or Hizo must give the other a Notice of
        ...
        Dispute via email to: hello@hizo.africa. Hizo will send any Notice of
        Dispute to you by mail to your address if we have it, or otherwise to
        your email address. You and Hizo will attempt to resolve any dispute
        through informal negotiation within sixty (60) days from the date the
        Notice of Dispute is sent. After sixty (60) days, you or Hizo may
        commence arbitration.
      </p>
    </div>
    <!-- Notice of Dispute end-->

    <!-- Binding Arbitration -->
    <div class="section">
      <h2>Binding Arbitration</h2>
      <p>
        If you and Hizo don’t resolve any dispute by informal negotiation, any
    ...
    <div class="section">
      ...
      <p>
        ...
        and will become the sole property of Hizo without any compensation or
        credit to you whatsoever. Hizo and its affiliates shall have no
    ...
    <!-- Submissions and Privacy end-->

    <!-- Promotions -->
    <div class="section">
      <h2>Promotions</h2>
      <p>
        Hizo may, from time to time, include contests, promotions, sweepstakes,
    ...
    <div class="section">
      ...
      <p>
        ...
        of Hizo. Hizo will be entitled to injunctive or other equitable relief
        (without the obligations of posting any bond or surety) in the event of
        any breach or anticipatory breach by you. Hizo operates and controls the
        Hizo Service from its offices in Nigeria. The Service is not intended
        ...
        regulation. Accordingly, those persons who choose to access the Hizo
        ...
        incorporate the Hizo Privacy Policy) contains the entire understanding,
        and supersedes all prior understandings, between you and Hizo concerning
    ...
    <div class="section">
      <h2>Disclaimer</h2>
      <p>
        Hizo is not responsible for any content, code or any other imprecision.
      </p>
      <p>Hizo does not provide warranties or guarantees.</p>
      <p>
        In no event shall Hizo be liable for any special, direct, indirect,
      ...
      <p>
        The Hizo Service and its contents are provided "as is" and "as
        available" without any warranty or representations of any kind, whether
        express or implied. Hizo is a distributor and not a publisher of the
        content supplied by third parties; as such, Hizo exercises no editorial
        ...
        service or merchandise provided through or accessible via the Hizo
        Service. Without limiting the foregoing, Hizo specifically disclaims all
        warranties and representations in any content transmitted on or in
        connection with the Hizo Service or on sites that may appear as links on
        the Hizo Service, or in the products provided as a part of, or otherwise
        in connection with, the Hizo Service, including without limitation any
        warranties of merchantability, fitness for a particular purpose or
        non-infringement of third party rights. No oral advice or written
        information given by Hizo or any of its affiliates, employees, officers,
        ...
        limiting the foregoing, Hizo does not warrant that the Hizo Service will
