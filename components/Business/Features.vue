        ...
        >
          <div class="max-w-lg pb-[15rem]">
            ...
            <p class="text-sm text-blue-100">
              Experience seamless and instant transactions between Hizo accounts
              with our Hizo to Hizo feature
            </p>
            <img
          ...
          <div class="max-w-lg">
            <div>
              ...
              <p class="text-sm">
                ...
                use of the Hizo App and get access to affordable lending credit
